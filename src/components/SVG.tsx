export const SVG = (props: React.HtmlHTMLAttributes<HTMLOrSVGElement>) => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 1233 1289" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
